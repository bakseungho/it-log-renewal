...
--color-accent-cyan-light: #33e3ff;
--color-accent-cyan-dark: #00b8d9;
```

**사용 가이드**:
- **Gold**: CTA 버튼, 프리미엄 요소, 강조 텍스트, 아이콘
- **Cyan**: AI/기술 관련 요소, 보조 CTA, 링크 호버
...
#### 포인트 컬러 우선순위
1. **Gold 우선**: CTA, 프리미엄 요소, 주요 강조
2. **Cyan 보조**: 기술 관련, 보조 CTA, 링크
3. **혼용 지양**: 한 화면에 두 컬러 동시 사용 최소화
...
--shadow-glow-cyan: 0 0 40px rgba(0, 217, 255, 0.3);
```
...
- **Gold 아이콘**: 프리미엄 서비스, 인증, 신뢰
- **Cyan 아이콘**: AI, 기술, 스마트 시스템
