...
**우선순위**:
1. **Primary (Gold)**: 주요 CTA, 폼 제출, 중요한 액션
2. **Secondary (Outline)**: 보조 CTA, 덜 중요한 액션
3. **Outline**: 카드 내부 버튼
4. **Text**: 인라인 링크, 더보기

**컬러 전략**:
- 골드 단일 컬러로 일관성 유지
- 호버 시 밝은 골드(#e6c966) 사용
- 액티브 시 어두운 골드(#b8941f) 사용
...
- **Gold**: 모든 포인트 요소 (CTA, 강조, 링크, 아이콘, 호버)
- **Gold 톤 변화**: 밝은 톤(호버), 기본 톤(일반), 어두운 톤(액티브)
- **White**: 주요 텍스트, 제목
- **Gray**: 보조 텍스트, 설명
